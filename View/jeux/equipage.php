...
<header class="masthead-equipage">
    <div class="container px-4 px-lg-5 h-100">
        <div class="row gx-4 gx-lg-5 h-100 mx-0 align-items-center justify-content-center text-center">
            <div class="col-lg-8 align-self-end">
                <h1 class="text-white font-weight-bold">Te voici à la page de création de ton équipage</h1>
                <hr class="divider" />
            </div>
            <div class="col-lg-8 align-self-baseline">
                <p class="text-white-75 mb-5">En premier lieu, choisis le nom de ton équipage, par la suite, les prochains bouton te donnerons ta race, ton fruit du démon, ton équipage de
                    5 membres,ton bateau ainsi que test pour voir ta prime.
